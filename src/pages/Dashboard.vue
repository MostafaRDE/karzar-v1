    ...
    <div id="parent-dashboard">
        ...
        <div class="container-fluid px-0" :style="{background: `#17161a url(${require('../../public/images/public/bg-pubg-sunset.jpg')}) center center / cover repeat-y`}">
            <div class="row">
                ...
                <div class="mb-0" :class="[{'z-index-10' : width >= 1024 || (width < 1024 && isSideBarActiveInResponsive)}, width >= 1024 ? 'col-sm-2' : 'position-fixed bottom-0', width < 1024 ? 'top-70' : '']" :style="{height: width >= 1024 ? 'calc(100vh - 90px)' : undefined, paddingLeft: '0 !important', paddingRight: '0 !important', minWidth: '275px'}">
