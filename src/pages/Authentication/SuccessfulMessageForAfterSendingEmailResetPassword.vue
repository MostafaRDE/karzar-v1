        ...
        <div class="w-90 mx-auto z-index-1" style="max-width: 500px">
            ...
            <div class="p-20 text-center" style="background: #0009">
                ...
                <h1 class="font-weight-100 text-center w-100 mb-30">{{
                    $t('pages.authentication.password_reset_link_sent.header')
                    }}</h1>

                {{ /* Button for goto login page */ }}
...
<script>
    ...
    export default {
        name: "MessageForAfterSendingEmailResetPassword",

        title: () => i18n.t('pages.authentication.password_reset_link_sent.title'),
        ...
        methods: {
            gotoLogin() {
                ...
                this.$store.commit('authentication/setMessagePasswordResetLinkSent', false);
                // Goto login page
