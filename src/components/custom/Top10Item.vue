        ...
        <div class="row" :class="width > 767 ? 'mx-0' : (width > 440 ? 'mx--10' : 'mx--20')" :style="{width: width > 767 ? '' : (width > 440 ? 'calc(100% + 20px)' : 'calc(100% + 40px)')}">
            <div class="col-6 d-flex">
                ...
                <div class="d-flex flex-direction-column justify-content-space-around" :class="width > 767 ? 'ms-20' : 'ms-10'">
                    <span class="text-white font-weight-900 d-flex align-items-center" :style="{fontSize: width > 767 ? '14px' : (width > 440 ? '12px' : '11px')}"><img src="/public/images/public/icons/ic-user.png" class="me-5" style="height: 14px" alt=""/>{{ data.name }}</span>
                    <span class="text-white d-flex align-items-center" :style="{fontSize: width > 767 ? '14px' : (width > 440 ? '12px' : '11px')}"><img src="/public/images/public/icons/ic-id.png" alt="" class="me-5" style="height: 14px"/>#{{ data.id }}</span>
                </div>
            </div>
            <div class="col-6 text-center text-sm-end d-flex align-items-center justify-content-flex-end">
                ...
                <img src="/public/images/public/icons/ic-head-shot.png" alt="" class="ms-10"/>
            </div>
        </div>
    </div>
</template>
