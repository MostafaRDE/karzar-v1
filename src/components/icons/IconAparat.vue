<template>
    <svg :style="`width:${width ? width : size};height:${height ? height : size}`" viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet">
        <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
           :fill="fill" stroke="none">
            <path :fill="fill" d="M1570 4615 c-30 -8 -93 -34 -140 -57 -115 -56 -230 -169 -283 -278
...
59 -86 3 -136 0 -175 -11z" />
            <path :fill="fill" d="M2388 4349 c-208 -20 -413 -78 -608 -170 -550 -262 -925 -766 -1015
...
202 -204 520 -3 721 128 127 319 179 494 134z" />
            <path :fill="fill" d="M3770 4112 c0 -4 20 -22 45 -40 114 -86 289 -279 395 -438 145 -215
...
-38 10 -68 16 -68 12z" />
            <path :fill="fill" d="M580 2237 c0 -4 -25 -100 -55 -214 -47 -179 -55 -220 -55 -298 0
...
-30 124 -30 101z" />
            <path :fill="fill" d="M4095 1319 c-22 -29 -81 -94 -131 -145 -272 -273 -629 -467 -1004
